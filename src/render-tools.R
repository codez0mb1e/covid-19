...
#'
#' @param filename 
#' @param toc_header_name 
#' @param base_level 
#' @param toc_depth 
#'
#' @seealso https://gist.github.com/gadenbuie/c83e078bf8c81b035e32c3fc0cf04ee8
#' 
render_toc <- function(
  filename, 
...
#' Format to percent
#'
format_to_percent <- function(.x) sprintf("%1.2f%%", 100*.x)
