...
ggplot(
  ...
  geom_hline(aes(yintercept = total_population*3e-4), linetype = "dashed", color = "black", alpha = .33) +
  annotate(geom = "text", label = "0.03% of world population", size = 3, color = "#666666", 
           x = min(world_spread$observation_date), y = (1.05*total_population*3e-4), 
...
ggplot(
  ...
  geom_hline(aes(yintercept = total_population*3e-4), linetype = "dashed", color = "black", alpha = .33) +
  annotate(geom = "text", label = "0.03% of world population", size = 3, color = "#666666", 
           x = Sys.Date() - weeks(4), y = (1.05*total_population*3e-4), 
           vjust = "bottom", hjust = "left") +
