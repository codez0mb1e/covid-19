...
active_cases_since_1st_confirmed <- population_spread %>% 
  ...
  mutate(
    double_every_14d = (1 + 1/14)^n_days_since_1st_confirmed, # double every 2 weeks
...
ggplot(active_cases_since_1st_confirmed, aes(x = n_days_since_1st_confirmed)) +
  ...
  geom_line(aes(y = double_every_14d), linetype = "dashed", color = "red", alpha = .55) +
  ...
  annotate(geom = "text", label = "...every 3 days", x = 25, y = 1800, vjust = 0, size = 3.2) +
  annotate(geom = "text", label = "...every week", x = 55, y = 2000, vjust = 0, size = 3.2) +
  annotate(geom = "text", label = "...every 2 weeks", x = 80, y = 300, vjust = 0, size = 3.2) +
...
active_cases_since_1st_death <- population_spread %>% 
  ...
  mutate(
    double_every_14d = (1 + 1/14)^n_days_since_1st_deaths, # double every 2 weeks
...
ggplot(
  ...
  annotate(geom = "text", label = "Active cases double \n every 2 days", x = 18, y = 1600, vjust = 0, size = 3.2) +
  annotate(geom = "text", label = "...every 3 days", x = 25, y = 1750, vjust = 0, size = 3.2) +
  annotate(geom = "text", label = "...every week", x = 40, y = 300, vjust = 0, size = 3.2) +
  annotate(geom = "text", label = "...every 2 weeks", x = 40, y = 100, vjust = 0, size = 3.2) +
