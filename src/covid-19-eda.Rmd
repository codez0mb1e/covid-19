...
ggplot(
  ...
  geom_hline(aes(yintercept = total_population*9e-4), linetype = "dashed", color = "black", alpha = .33) +
  annotate(geom = "text", label = "0.09% of world population", size = 3, color = "#666666", 
           x = min(world_spread$observation_date), y = (1.05*total_population*9e-4), 
...
ggplot(
  ...
  geom_hline(aes(yintercept = total_population*9e-4), linetype = "dashed", color = "black", alpha = .33) +
  annotate(geom = "text", label = "0.09% of world population", size = 3, color = "#666666", 
           x = Sys.Date() - weeks(4), y = (1.05*total_population*9e-4), 
           vjust = "bottom", hjust = "left") +
...
ggplot(
  ...
  annotate(geom = "text", label = "Mean mortality rate \n(over time, all countries)", x = 4, y = 1.1*mean(countries_mortality$confirmed_deaths_rate), vjust = 0, size = 3) +
...
ggplot(
  ...
  annotate(geom = "text", label = "Mean mortality rate \n(over time, all countries)", x = 4, y = 1.1*mean(countries_mortality$recovered_deaths_rate, na.rm = T), size = 3) +
